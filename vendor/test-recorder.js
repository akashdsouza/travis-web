(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("TestRecorder", [], factory);
	else if(typeof exports === 'object')
		exports["TestRecorder"] = factory();
	else
		root["TestRecorder"] = factory();
})(this, function() {
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__util_MutationUtils__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__codeGenerators_NightwatchGenerator__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__styles_app_pcss__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__styles_app_pcss___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__styles_app_pcss__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__util_clipboard__ = __webpack_require__(18);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_prismjs__ = __webpack_require__(10);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_prismjs_components_prism_javascript__ = __webpack_require__(9);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__codeGenerators_EmberCLI__ = __webpack_require__(14);
...
class TestRecorder {
    constructor() {
        this.mutationObserversArr = [];
        this.generatedTestCode = ''; //this is sent to what ever wants to receive generated code
        this.cachedMutations = ''; //this stores the changes made from mutations until we want to insert them into the generated code
        let nightwatchGenerator = new __WEBPACK_IMPORTED_MODULE_1__codeGenerators_NightwatchGenerator__["a" /* NightwatchGenerator */]();
        let emberCLIGenerator = new __WEBPACK_IMPORTED_MODULE_6__codeGenerators_EmberCLI__["a" /* EmberCLIGenerator */]();
    ...
    addListeners() {
        ...
        document.querySelector('#copy').addEventListener('click', () => {
            __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__util_clipboard__["a" /* copyTextToClipboard */])(this.hostElement.textContent);
        });
        document.querySelector('#framework-choice').addEventListener('change', (event) => {
    ...
    childListMutation(mutationRecord) {
        ...
        addedNodesArray = addedNodesArray.filter(__WEBPACK_IMPORTED_MODULE_0__util_MutationUtils__["a" /* default */].filter_DoNotRecord_WhiteSpace_emberID_noID);
        removedNodesArray = removedNodesArray.filter(__WEBPACK_IMPORTED_MODULE_0__util_MutationUtils__["a" /* default */].filter_DoNotRecord_WhiteSpace_emberID_noID);
...
/* harmony export (immutable) */ __webpack_exports__["a"] = TestRecorder;

TestRecorder.MUTATIONS_PLACEHOLDER = '[MUTATIONS_PLACEHOLDER]';
TestRecorder.DO_NOT_RECORD = 'doNotRecord';
/**
...
function isAnyElementInPathClassOrChildOfClass(path, className) {
...
function isElementClassOrChildOfClass(element, className) {
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js??ref--1-1!../../node_modules/postcss-loader/index.js!./app.pcss", function() {
			var newContent = require("!!../../node_modules/css-loader/index.js??ref--1-1!../../node_modules/postcss-loader/index.js!./app.pcss");
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__util_formattingRules__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__TestRecorder__ = __webpack_require__(0);


class EmberCLIGenerator {
    constructor() {
        this.lastRoute = '';
        this.description = 'EMBER_CLI';
        // tslint:disable-line
    }
    selectChange(queryPath, event) {
        let target = event.target;
        let newSelectedIndex = target.selectedIndex;
        let newValue = target.options[newSelectedIndex].value;
        let code = `
Ember.$("${queryPath}").trigger({type:'mouseup', which:1})
andThen(function () {
${__WEBPACK_IMPORTED_MODULE_0__util_formattingRules__["a" /* default */].indentationX2}${__WEBPACK_IMPORTED_MODULE_1__TestRecorder__["a" /* TestRecorder */].MUTATIONS_PLACEHOLDER}
})`;
        return code;
    }
...
${__WEBPACK_IMPORTED_MODULE_0__util_formattingRules__["a" /* default */].indentationX2}${__WEBPACK_IMPORTED_MODULE_1__TestRecorder__["a" /* TestRecorder */].MUTATIONS_PLACEHOLDER}
    ...
    characterDataChanged(record) {
        let el = record.target;
        return `equal(find('#${el.parentElement.id}').text(), '${el.nodeValue}')
    `;
    }
}
/* harmony export (immutable) */ __webpack_exports__["a"] = EmberCLIGenerator;
...
class NightwatchGenerator {
    constructor() {
        this.lastRoute = '';
        this.description = 'NightWatch generator';
        // tslint:disable-line
    }
    selectChange(queryPath, event) {
        let target = event.target;
...
browser.pause(500)
${__WEBPACK_IMPORTED_MODULE_1__TestRecorder__["a" /* TestRecorder */].MUTATIONS_PLACEHOLDER}`;
        return code;
    }
    clickHappened(queryPath) {
        let code = `
...
${__WEBPACK_IMPORTED_MODULE_1__TestRecorder__["a" /* TestRecorder */].MUTATIONS_PLACEHOLDER}`;
    ...
    routeChanged() {
        if (this.lastRoute !== this.getCurrentRoute()) {
            ...
            let code = __WEBPACK_IMPORTED_MODULE_0__util_formattingRules__["a" /* default */].indentation + '.assert.equal(currentRouteName(), "' +
...
/* harmony export (immutable) */ __webpack_exports__["a"] = NightwatchGenerator;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__TestRecorder__ = __webpack_require__(0);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "TestRecorder", function() { return __WEBPACK_IMPORTED_MODULE_0__TestRecorder__["a"]; });
